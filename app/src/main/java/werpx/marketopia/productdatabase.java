...
import werpx.marketopia.RoomDatabase.Sqlieofflinehistory;
...
public class productdatabase extends SQLiteOpenHelper {
    ...
    public List<Sqlitetable> getofflineproducts()
    {
        ...
        while (cursor.moveToNext()) {
           ...
           byte[] imgblob = cursor.getBlob(indexxxxx);
            ...
            myproducts.add(new Sqlitetable(null,null,barcode,price,img,null,localnam,null,null));
    ...
    public Boolean insertdatalistproducts(String name, String bar, String price, String img, String detail ,String idproduct,String localnam,byte[] imgblob,Integer fav) {
     ...
     public Boolean updatefavcondition(String barcode)
     {
        ...
        String getrow= "SELECT Prod_fav FROM "+Tablename1+" WHERE "+columnb+" = "+barcode+";";
         ...
         int value=0;
         Cursor c = dbr.rawQuery(getrow,null);
         if(c.getCount() == 1){
             c.moveToFirst();
             value = c.getInt(c.getColumnIndex(columni));
         }
         c.close();
    ...
    public List<Sqlitetable> getproductsitems()
    {
        ...
        while (cursor.moveToNext()) {
          ...
          byte[] blob=cursor.getBlob(indeximgblob);
            ...
            int indeximgfav=cursor.getColumnIndexOrThrow(columni);
           int i=cursor.getInt(indeximgfav);



            myproducts.add(new Sqlitetable(idproduct,name,barcode,price,img,null,namelocal,blob,i));
     ...
     try {
         ...
         if (cursor.getCount() > 0) {
            ...
            byte[]imgblob=cursor.getBlob(indeximg);
             ...
             mytable = new Sqlitetable(idproduct,nam, bar, price, img, detail,localnam,imgblob,i);
     }
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
               ...
               byte[] imgblon = cursor.getBlob(indexxxx);
                ...
                mytable = new Sqlitetable(null,nam, bar, price, null, null,namlocal,imgblon,null);
            }
            db.setTransactionSuccessful();
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
               ...
               byte[] imgblob = cursor.getBlob(indexxx);
                ...
                mytable = new Sqlitetable(null,nam, bar, price, null, null,namlocal,imgblob,null);
            }
            db.setTransactionSuccessful();
