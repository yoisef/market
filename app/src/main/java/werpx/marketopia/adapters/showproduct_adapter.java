...
import werpx.marketopia.RoomDatabase.ProductRoomDatabase;
...
public class showproduct_adapter extends RecyclerView.Adapter<showproduct_adapter.viewholder> {
    ...
    ProductRoomDatabase roomDatabase;
    ...
    public showproduct_adapter(Context con)
    {
        ...
        roomDatabase = Room.databaseBuilder(getApplicationContext(), ProductRoomDatabase.class, "product").allowMainThreadQueries().build();
...
*/
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(mycontext).inflate(R.layout.rowspeacial, parent, false);
    ...
    public void onBindViewHolder(@NonNull final viewholder holder, final int position) {
        ...
        if (products!=null)
        {
            ...
            {
                holder.favouritspeacial.setImageResource(R.drawable.heartgray);
            ...
            for (i = 0; i < myproducts.size(); i++) {
                if (barcod.trim().equals(myproducts.get(i).getPbar().trim())) {
                   ...
                   mytable current = myproducts.get(i);
                    ...
                    roomDatabase.wordDao().updateproduct(current.getPitemn()+1,Long.parseLong(barcod));
                    mycondition=false;
                    //    mycard.setClickable(true);
                  //  Toast.makeText(mycontext,mycontext.getResources().getString(R.string.addedtocart),Toast.LENGTH_SHORT).show();

                    if (lastposition!=i)
                    {
//                        ((Shoppingbasket) mycontext).scrolltoposition(i);
    ...
    private void getproductbybarcode(final String barcode, final CardView card)
    {
      ...
      Sqlitetable mytablee= mydatabase.getdataforrowinfinalproductoffline(barcode);
        ...
        if (mytable!=null)
        {
            ...
            roomDatabase.wordDao().insert(new mytable(mytable.getPid(),mytable.getName(),mytable.getBarcode(),Integer.parseInt("1"),mytable.getImge(),mytable.getDescription(),mytable.getPrice(),null,mytable.getLocalnam(),mytable.getImgblob()));
        ...
        {
            roomDatabase.wordDao().insert(new mytable(mytablee.getPid(),mytablee.getName(),mytablee.getBarcode(),Integer.parseInt("1"),mytablee.getImge(),mytablee.getDescription(),mytablee.getPrice(),null,mytablee.getLocalnam(),mytablee.getImgblob()));
          //  Toast.makeText(mycontext,mycontext.getResources().getString(R.string.addedtocart),Toast.LENGTH_SHORT).show();
    ...
    class viewholder extends RecyclerView.ViewHolder{
        ...
        ImageView myimg,favouritspeacial;
        CardView mycard;
        TextView textprice;
        ...
        public viewholder(View itemView) {
            ...
            favouritspeacial=itemView.findViewById(R.id.favouritimgspeacial);
